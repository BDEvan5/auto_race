...
public:
    BehaviorController() {
        ...
        n.getParam("planner_mux_idx", planner_mux_idx);
        // ***Add mux index for new planner here***
        ...
        n.getParam("planner_button_idx", planner_button_idx);
        // ***Add button index for new planner here***
        ...
        n.getParam("planner_key_char", planner_key_char);
        // ***Add key char for new planner here***
    ...
    void key_callback(const std_msgs::String & msg) {
        ...
        if (msg.data == joy_key_char) {
            ...
            // nav
            toggle_mux(nav_mux_idx, "Navigation");
        } else if (msg.data == planner_key_char) {
            toggle_mux(planner_mux_idx, "Planner");
        }
        // ***Add new else if statement here for new planning method***
